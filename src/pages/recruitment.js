        ...
        ${jobs.map((j, i) => `
          <article class="job-card animate-in" style="animation-delay:${i * 0.1}s">
            <div class="job-card-body">
              ...
              <p style="color:var(--text-light);font-size:.9rem;margin-bottom:12px">${j.description}</p>
              <div class="date">${icon('calendar', 14)} Ngày đăng: ${j.date}</div>
              <div style="margin-top:16px;display:flex;gap:12px">
                <a href="mailto:pkd.sanfovet@gmail.com?subject=Ứng tuyển: ${encodeURIComponent(j.title)}" class="btn-primary" style="font-size:.85rem;padding:10px 20px">${icon('mail', 16)} Gửi CV qua Email</a>
