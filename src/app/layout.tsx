...
export const metadata: Metadata = {
  title: {
    default: "BIOTECH-VET - Công Ty Cp Công Nghệ Sinh Học Thú Y - Dược Thú Y Công Nghệ USA | Chất Lượng Vượt Trội",
  ...
  openGraph: {
    ...
    title: "BIOTECH-VET - Công Ty Cp Công Nghệ Sinh Học Thú Y - Dược Thú Y Công Nghệ USA",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BIOTECH-VET - Công Ty Cp Công Nghệ Sinh Học Thú Y - Công nghệ USA",
      },
    ],
  },
  twitter: {
