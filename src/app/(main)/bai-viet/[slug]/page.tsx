...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      title: article.title,
      description: plainTextContent,
      url: `https://biotechvet.com.vn/bai-viet/${article.slug}`,
             ...
             <article className="prose prose-lg max-w-none prose-headings:text-biotechvet-dark prose-headings:font-black prose-p:text-gray-600 prose-p:leading-relaxed">
                <header className="mb-10 not-prose">
                   <div className="flex items-center gap-4 text-sm text-gray-400 font-bold mb-4 uppercase tracking-widest">
                      ...
                      <span className="flex items-center gap-1.5"><User size={14} /> biotechvet Editor</span>
                   </div>
                ...
                <footer className="mt-16 pt-10 border-t border-gray-100 not-prose">
                   <div className="bg-biotechvet-alt p-8 rounded-[32px] border border-primary/10 flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div>
                         <h4 className="font-black text-xl text-biotechvet-dark mb-2">Đội ngũ Kỹ thuật BIOTECH-VET</h4>
                         <p className="text-gray-500 font-medium leading-relaxed mb-4">
                            Bài viết được tham vấn chuyên môn bởi các bác sĩ thú y giàu kinh nghiệm của Hội đồng Kỹ thuật biotechvet. Chúng tôi cam kết mang đến những kiến thức chính xác và giải pháp tối ưu cho người chăn nuôi.
                         </p>
             ...
             <div className="sticky top-24 space-y-12">
                 ...
                 {headings.length > 0 && (
                   <div className="bg-biotechvet-alt p-6 rounded-[24px] border border-gray-100">
                     <h3 className="font-black text-lg text-biotechvet-dark mb-4 flex items-center gap-2 uppercase tracking-wider">
                ...
                {/* Newsletter Box */}
                <div className="bg-biotechvet-dark rounded-[32px] p-8 text-white relative overflow-hidden group">
