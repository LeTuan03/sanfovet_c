        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {featuredProducts.map((p: Product, index: number) => (
              ...
              <article className="bg-white rounded-[32px] shadow-sm hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 group flex flex-col relative hover:-translate-y-2 h-full">
                ...
                <div className="p-6 lg:p-8 flex-1 flex flex-col items-center text-center">
                  <h3 className="font-black text-lg lg:text-xl text-biotechvet-dark mb-3 leading-tight group-hover:text-primary transition-colors flex-1">{p.name}</h3>
                  <Link 
