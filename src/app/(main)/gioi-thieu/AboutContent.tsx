            ...
            <div className="flex overflow-x-auto hide-scrollbar gap-3 mb-12 bg-gray-50/80 backdrop-blur-sm p-3 rounded-3xl lg:rounded-full border border-gray-100 shadow-sm md:flex-wrap">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`shrink-0 flex items-center gap-2 px-6 py-3.5 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 ${activeTab === tab.id
