              ...
              {content.coCau.roles.map((role, i) => {
                ...
                return (
                  <div key={`${role}-${i}`} className="relative">
                    ...
                    <div
                      className={`p-5 md:p-6 text-center font-black uppercase tracking-widest text-sm md:text-base mx-auto transition-all duration-300 hover:-translate-y-0.5 ${isTop
