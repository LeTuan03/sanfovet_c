...
export const metadata: Metadata = {
  title: "Giới Thiệu - BIOTECH-VET | Công Ty Cổ Phần Công Nghệ Sinh Học Thú Y",
  description: "Tìm hiểu về BIOTECH-VET - Công Ty Cổ Phần Công Nghệ Sinh Học Thú Y, đơn vị tiên phong trong sản xuất dược thú y công nghệ USA tại Việt Nam.",
