...
export default function DiseasesPage() {
  const list = articles.filter(a => a.category === 'benh-dieu-tri');
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="mt-24 bg-sanfovet-alt rounded-[48px] p-10 md:p-16 flex flex-col md:flex-row items-center gap-12 border border-primary/10">
           ...
           <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-600 font-medium max-w-2xl">Đội ngũ Bác sĩ Thú y của Sanfovet luôn sẵn sàng lắng nghe và tư vấn miễn phí cho bạn 24/7. Đừng ngần ngại liên hệ khi gặp dấu hiệu bất thường trên đàn vật nuôi.</p>
           </div>
