# Phân Tích Website biotechvet.com.vn
...
| 2 | **Về chúng tôi** | Giới thiệu ngắn gọn về biotechvet, link đến `/gioi-thieu/` và `/catalogue/` |
...
- Gợi ý sản phẩm biotechvet liên quan (cross-sell nội dung)
...
Email:         pkd.biotechvet@gmail.com
Website:       www.biotechvet.com.vn
...
Email gửi đến pkd.biotechvet@gmail.com → 
...
- **Email click-to-email:** `pkd.biotechvet@gmail.com`
...
Điền form liên hệ / gọi hotline
    │
    ▼
Nhân viên biotechvet phản hồi tư vấn
```
...
Đọc thông tin: triệu chứng, chẩn đoán, điều trị
    │
    ▼
Xem sản phẩm biotechvet được gợi ý trong bài viết
    │
    ▼
...
| **Email float button** | Click | Mở email client với địa chỉ `pkd.biotechvet@gmail.com` |
...
| Hạng mục | Chi tiết |
|----------|----------|
| **CMS** | WordPress (Custom Theme: `biotechvet`) |
